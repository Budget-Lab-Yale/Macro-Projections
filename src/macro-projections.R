...
# Define data paths
cbo_path <- paste0("/nfs/roberts/project/pi_nrs36/shared/raw_data/CBO/v2/", cbo_vintage, "/baseline/")
ssa_path <- paste0("/nfs/roberts/project/pi_nrs36/shared/raw_data/SSA/v2/", ssa_vintage, "/historical/")
out_path <- paste0("/nfs/roberts/project/pi_nrs36/shared/model_data/Macro-Projections/v2/", out_vintage, "/baseline/")
